...
// Crecimiento: gráfico de 3 barras ascendentes (viewBox 24).
const GROWTH_PATH =
  'M3 21 L7 21 L7 15 L3 15 Z M10 21 L14 21 L14 10 L10 10 Z M17 21 L21 21 L21 5 L17 5 Z'
...
// Íconos de IG, TikTok y crecimiento repartidos alrededor del texto.
const ICONS: IconDef[] = [
  { path: IG_PATH, color: '#FE688E', scale: 1.6, pos: [-2.7, 0.6, -1], float: { speed: 1.1, rot: 0.4, floatI: 1 }, spin: 0.25 },
  { path: TT_PATH, color: '#2BA8E0', scale: 1.5, pos: [2.8, -0.5, -0.4], float: { speed: 1.3, rot: 0.4, floatI: 1.1 }, spin: -0.3 },
  { path: GROWTH_PATH, color: '#F4B400', scale: 1.1, pos: [2.3, 1.7, -1.2], float: { speed: 1.6, rot: 0.5, floatI: 1.2 }, spin: 0.4 },
  { path: TT_PATH, color: '#FE688E', scale: 1.0, pos: [-2.3, -1.5, -0.8], float: { speed: 1.5, rot: 0.5, floatI: 1.1 }, spin: 0.3 },
  { path: IG_PATH, color: '#2BA8E0', scale: 0.9, pos: [-3.1, 1.5, -1.4], float: { speed: 1.4, rot: 0.5, floatI: 1 }, spin: -0.28 },
  { path: GROWTH_PATH, color: '#F4B400', scale: 0.95, pos: [3.1, 0.6, -1.3], float: { speed: 1.4, rot: 0.6, floatI: 1.1 }, spin: -0.35 },
]
